...
(function () {
  var consent = "By sharing your number, you agree to receive wedding reminder and livestream-alert texts from Joshua and Lucia (up to 4 messages: welcome, 7 days before, 1 day before, and the day of). Message and data rates may apply. Reply STOP to unsubscribe.";
  must(index, consent, "reminder form has on-page SMS consent");
  must(rsvpHtml, consent, "RSVP phone field has on-page SMS consent");
