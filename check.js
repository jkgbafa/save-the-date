...
(function () {
  ...
  must(fund, "assets/monogram-sage.png", "gifts section uses the gold emblem");
...
must(index, "assets/monogram-sage.png", "committed wedding emblem asset");
...
(function () {
  ...
  must(cover, "assets/monogram-sage.png", "J and L monogram stays on the hero");
})();
...
if (!fs.existsSync("assets/monogram-sage.png") || !fs.existsSync("assets/og-share.png") || !fs.existsSync("assets/floral-cream-gold.png")) {
  console.error("assets/monogram-sage.png, assets/og-share.png, and assets/floral-cream-gold.png must exist");
  process.exitCode = 1;
}
